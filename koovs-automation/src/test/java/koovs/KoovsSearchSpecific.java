...
public class KoovsSearchSpecific extends Tools {
@Test
	...
	public void koovsaddtocart() throws IOException, InterruptedException
	{
		...
		Thread.sleep(1000);
		driver.findElement(By.id("search-input-field")).sendKeys("Alcott");
		Thread.sleep(5000);
		webDriverWait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[text()='Alcott']")));
		driver.findElement(By.xpath("//span[text()='Alcott']")).click();
		Thread.sleep(5000);
	}
