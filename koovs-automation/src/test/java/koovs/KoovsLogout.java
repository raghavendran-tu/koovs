...
public class KoovsLogout  extends Tools {
	
	@Test
		
		
		public void koovslogout() throws InterruptedException, IOException
		{
			...
			Thread.sleep(3000);
			webDriverWait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='sprite-item h_myaccount']")));
			Actions actions = new Actions(driver);
			actions.moveToElement(driver.findElement(By.xpath("//div[@class='sprite-item h_myaccount']"))).build().perform();
			Thread.sleep(3000);
